...
export default function FormPage() {
    ...
    useEffect(() => {
        ...
        if (state?.status === 200) {
            toast.success(`Guarantor ${confirmData.name} is successfully registered!`);
            setConfirmData({
                name: '',
                nrcNo: '',
                dateOfBirth: new Date("2000-01-01").toISOString().split("T")[0],
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            Register <strong>{confirmData.name}</strong> as Guarantor?
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
                        ...
                        <CardContent>
                            <div className="grid grid-cols-4 gap-4">
                                ...
                                <div className="col-span-3 grid grid-cols-4 gap-4">
                                    ...
                                    <div className="col-span-2">
                                        <Label>Phone</Label>
                                        <Input name="phone" value={confirmData.phone} onChange={handleChange} disabled={isPending} type="text" size={11} required />
                                    </div>
                                    <div className="col-span-2">
                                        <Label>Email</Label>
